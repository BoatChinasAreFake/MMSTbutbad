...
def run_simulation():
    ...
    test_asymmetry(gb_all, "Great Britain Connected")
    test_asymmetry(england_wales, "England + Wales (excluding Scotland)")
    test_asymmetry(england, "England Alone (excluding Scotland & Wales)")
    test_asymmetry(ireland, "Ireland")
