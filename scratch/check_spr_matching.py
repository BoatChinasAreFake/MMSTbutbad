...
# Let's trace the exact candidate matching for a Spain province, say Madrid region (2600, 820)
...
print("SPR in countries_list:", "SPR" in countries_list)
print("COM in countries_list:", "COM" in countries_list)
if "SPR" in countries_list:
    print("SPR color in list:", colors.get("SPR"))
if "COM" in countries_list:
    print("COM color in list:", colors.get("COM"))
