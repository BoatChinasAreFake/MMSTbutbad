...
def run_simulation():
    ...
    test_optimal_asymmetry(gb_all, "Great Britain Connected")
    test_optimal_asymmetry(england_wales, "England + Wales (excluding Scotland)")
    test_optimal_asymmetry(england, "England Alone (excluding Scotland & Wales)")
    test_optimal_asymmetry(ireland, "Ireland")
